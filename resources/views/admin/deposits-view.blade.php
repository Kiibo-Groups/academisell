                ...
                <div class="card shadow-custom border-0">
                    <div class="card-body p-lg-5">
                        ...
                        <dl class="row">
                            ...
                            <dd class="col-sm-10">
                                {{ $data->txn_id != 'null' ? $data->txn_id : __('general.not_available') }}</dd>
                            ...
                            <dd class="col-sm-10"><strong
                                    class="text-success">{{ App\Helper::amountFormat($data->amount) }}</strong></dd>

                            <dt class="col-sm-2 text-lg-end">{{ trans('general.payment_gateway') }}</dt>
                            <dd class="col-sm-10">
                                {{ $data->payment_gateway == 'Bank Transfer' ? __('general.bank_transfer') : $data->payment_gateway }}
                            </dd>
                        ...
                        @if ($data->status == 'pending')
                            <div class="row mb-3">
                                <div class="col-sm-10 offset-sm-2">
                                    ...
                                    {!! Form::hidden('id', $data->id) !!}
                                    {!! Form::button('<i class="bi-trash me-2"></i>' . trans('general.delete'), [
                                        'class' => 'btn btn-danger pull-right margin-separator actionDelete',
                                    ]) !!}
